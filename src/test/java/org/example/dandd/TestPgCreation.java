...
public class TestPgCreation
{
		...
		public void testDb()
		{
			...
			sanniHeavyAtk.setDescriptionAction("Una tempesta di dati energetici scatena il caos sul campo di battaglia.\n" +
			...
			sandorSpecialAtk.setPrecision(10);
...
//			ANGULORC - orchi guerrieri di Angular, attaccano usando delle String come clave, molto forti fisicamente ma poco intelligenti
//			HP 140, ATK 25, DEF 12, SPEED 25
//			MOSSE - Base (25), ByteSlam (35, cooldown 2 turni)
			...
			baseAngulorc.setDescriptionAction("ti do un pugno");
			...
			specialAngulorc.setNameAction("Pugno di stringhe");
			specialAngulorc.setMaxNumTarget(1);
			specialAngulorc.setDescriptionAction("ti do un pugno speciale");
			specialAngulorc.setPrecision(100);
			specialAngulorc.setEntity(angulorc);
			aDao.save(baseAngulorc);

//			OGRESQL- grossi ogre corazzati messi a guardia dei Database SQL, sono ben protetti da armature di Query, attaccano con i loro pugni
//			HP 160, ATK 20, DEF 18, SPEED 10
//			MOSSE - Base (20), QuerySmash (30, gli avversari sono rallentati di 5 nel prossimo turno, cooldown 3 turni)

			Monster ogreSql = new Monster();
			ogreSql.setName("OgreSql");
			...
			baseOgre.setNameAction("Pugno di ogre");
			baseOgre.setMaxNumTarget(1);
			baseOgre.setDescriptionAction("ti do un pugno");
			...
			specialeOgre.setNameAction("Pugno di stringhe");
			specialeOgre.setMaxNumTarget(3);
			specialeOgre.setDescriptionAction("ti do un pugno speciale");
			specialeOgre.setPrecision(100);
			specialeOgre.setEntity(ogreSql);
			aDao.save(specialeOgre);


//			BACK-ENDER - maestosi e misteriosi cavalieri neri, i terminatori del back end, formidabili distruttori di codice. Si vocifera che uno solo di questi, possa mandare in down il PlaystationNetwork per 1 giorno intero.
//			HP 150, ATK 40, DEF 14, SPEED 30
//			MOSSE - Base (40), ExceptionSlash (30, colpisce tutti gli avversari, cooldown 3 turni)
			...
			baseBack.setNameAction("Pugno di back");
			baseBack.setMaxNumTarget(1);
			baseBack.setDescriptionAction("ti do un pugno");
			...
			specialeBack.setMolt(0.75);
			specialeBack.setCooldown(3);
			specialeBack.setNameAction("Pugno di stringhe");
			specialeBack.setMaxNumTarget(3);
			specialeBack.setDescriptionAction("ti do un pugno speciale");
			specialeBack.setPrecision(100);
			specialeBack.setEntity(backEnder);
			aDao.save(specialeBack);


//			IL CODICE SORGENTE - Stringhe di codice verde su sfondo nero scorrono, prendendo la forma che hanno gli incubi. Un terrificante sviluppatore Zoom ha preso il controllo del codice binario, la base di tutta l'informatica, dandogli la forma di un drago per distruggere ogni cosa, e infine terminare se stesso, per porre fine all'informatica e rimandare la civiltà indietro di centinaia di anni.
//			HP 200, ATK 50, DEF 20, SPEED 50
//			MOSSE - Base (50), W0RLD 3ND3R (50 ad area su tutti, cooldown 3 turni)
			...
			baseSource.setNameAction("Pugno di back");
			baseSource.setMaxNumTarget(1);
			baseSource.setDescriptionAction("ti do un pugno");
			...
			specialeSource.setMolt(1);
			specialeSource.setCooldown(3);
			specialeSource.setNameAction("Pugno di stringhe");
			specialeSource.setMaxNumTarget(3);
			specialeSource.setDescriptionAction("ti do un pugno speciale");
